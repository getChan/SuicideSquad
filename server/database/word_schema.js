...
Schema.createSchema = function(mongoose) {
	...
	var WordSchema = mongoose.Schema({
        ...
        , hand_explain: {type:String, 'default':''}
        , word_information : {type:String, 'default': ''}
        , word_example : {type:String, 'default': ''}
        , word_explain : {type:String, 'default': ''}
	});
	...
	WordSchema
	  ...
	  .set(function(id) {
	    this.id = id;
	    console.log('virtual id호출됨 : ' + this.id);
	  })
