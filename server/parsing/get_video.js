...
var origin_no = 0; //현재 페이지 단어의 총 개수는 12614개
var word_number = 100;
//변수 선언
//다운로드

//저장할 디렉터리가 없으면 생성
var savedir = __dirname + "/video";
...
for(; origin_no <=word_number; origin_no++){
    ...
    //url 지정
    var url ="http://sldict.korean.go.kr/front/sign/include/controlVideoSpeed.do?origin_no="+origin_no;
    var param = {};
